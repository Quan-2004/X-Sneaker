...
import { ref, get, push, update, remove, onValue } from 'https://www.gstatic.com/firebasejs/12.8.0/firebase-database.js';
...
function setupRealtimeListeners() {
    ...
    onValue(promotionsRef, (snapshot) => {
        if (snapshot.exists()) {
            ...
            state.promotions = Object.entries(promotionsData).map(([id, promo]) => ({
                id,
                ...promo
            }));
            applyFilters();
